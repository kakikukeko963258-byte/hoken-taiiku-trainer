...
if "%ERRORLEVEL%"=="2" (
  ...
  echo Starting Hoken-Taiiku app server on port %PORT%...
  start "hoken-taiiku-server" /min cmd /k "node dev-server.mjs %PORT%"
...
echo The server window is minimized as "hoken-taiiku-server".
